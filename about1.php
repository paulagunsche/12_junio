...
<body>
  ...
  <div class="tab-content">
      ...
      <div role="tabpanel" class="tab-pane" id="profile">
        <?php
      $json = file_get_contents('data/biblio1.json');
      $datos = json_decode($json,true);
      $todos = count($datos);
      //print_r ($todos);
      echo datos[0]['year'];
...
<div class="post-preview">
  <p><?php echo($datos[$n]["autor"]);?> (<?php echo($datos[$n]["year"]);?>). <?php echo($datos[$n]["name"]);?>. <?php echo($datos[$n]["city"]);?>:<?php echo($datos[$n]["ed"]);?> <?php echo($datos[$n]["link"]);?></p>
</div>
<?php }; ?>
</div>
</div>
